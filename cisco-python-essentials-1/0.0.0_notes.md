...
- `2 == 2.` | `2. == 2` is True
- `if variable:` is the same as `if bool(variable) is True:` or `if variable is not None:`
...
print(f'''
Integer: 1 - {bool(1)} | 0 {bool(0)} | -1 {bool(-1)}
Floating point: 1.0 - {bool(1.0)} | 0.0 {bool(0.0)} | -1.0 {bool(-1.0)}
String: 'Teste' - {bool('Teste')} | '' {bool('')} | '0' {bool('0')}
